  ...
  return (
    ...
    <span className='px-[2rem] text-[#55e6a5] py-[0.9rem] font-bold text-[18px] border-[2px] border-[#55e6a5]'>
        ...
        <p className='text-[#aaaaaa] font-normal w-[80%] text-[17px] opacity-80'>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. A harum iure tempore non eum culpa nostrum ut suscipit. Voluptatem vitae excepturi fuga maxime error recusandae tenetur quod praesentium at laborum?
        </p>
    </div>
  );
};
