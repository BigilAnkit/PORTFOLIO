...
const MobileNav = ({nav,closeNav}:Props) => {
  ...
  return (
    ...
    <div className='absolute z-[1000000000] cursor-pointer top-[2rem] right-[2rem] w-[2rem] h-[2rem] text-yellow-400'>
    <XMarkIcon/>
    </div>
 
    <div onClick={closeNav}
    className='absolute cursor-pointer top-[2rem] right-[2rem] w-[2rem] h-[2rem] test-yellow-400'></div>
    </div>
